...
export class RoleHelper {
  ...
  protected readonly namingProvider: INamingProvider;
  ...
  private createS3Ops(operations: Operations[]) {
  ...
  private getTableEncryptionKey(table: dynamodb.ITable): IKey | undefined {
    ...
    if (
      ...
      return tableProps.encryptionKey as IKey;
    }
    return undefined;
  }
}
